...
* The original package name 'com.suny.sp-native-01' is invalid and this project uses 'com.suny.spnative01' instead.
...
```
$ docker run --rm -p 8080:8080 sp-native-01:0.0.1-SNAPSHOT
```
